...
AddOption(tpcCFqmaxCutoff, char, 3, "", 0, "Cluster Finder rejects cluster with qmax below this threshold")
AddOption(tpcCFqtotCutoff, char, 0, "", 0, "Cluster Finder rejects cluster with qtot below this threshold")
AddOption(tpcCFinnerThreshold, char, 0, "", 0, "Cluster Finder extends cluster if inner charge above this threshold")
AddOption(tpcCFminSplitNum, char, 1, "", 0, "Minimum number of split charges in a cluster for the cluster to be marked as split")
AddOption(tpcCFnoiseSuppressionEpsilon, char, 10, "", 0, "Cluster Finder: Difference between peak and charge for the charge to count as a minima during noise suppression")
