...
AddOption(tpcCFqmaxCutoff, float, 3.0f, "", 0, "Cluster Finder rejects cluster with qmax below this threshold")
AddOption(tpcCFqtotCutoff, float, 0.f, "", 0, "Cluster Finder rejects cluster with qtot below this threshold")
AddOption(tpcCFinnerThreshold, float, 0.f, "", 0, "Cluster Finder extends cluster if inner charge above this threshold")
AddOption(tpcCFminSplitNum, float, 1.f, "", 0, "Minimum number of split charges in a cluster for the cluster to be marked as split")
AddOption(tpcCFnoiseSuppressionEpsilon, float, 10.f, "", 0, "Cluster Finder: Difference between peak and charge for the charge to count as a minima during noise suppression")
