...
class GPUTPCCFClusterizer : public GPUKernelTemplate
{
 ...
 public:
  ...
  static GPUd() void computeClustersImpl(int, int, int, int, const CfFragment&, GPUSharedMemory&, const Array2D<PackedCharge>&, const ChargePos*, const TPCCFCalibration&, MCLabelAccumulator*, uint, uint, uint*, tpc::ClusterNative*, uint*);

 private:
  static GPUd() void updateClusterInner(const TPCCFCalibration&, ushort, ushort, const PackedCharge*, const ChargePos&, ClusterAccumulator*, MCLabelAccumulator*, uchar*);
  ...
  static GPUd() void buildCluster(const TPCCFCalibration&, const Array2D<PackedCharge>&, ChargePos, ChargePos*, PackedCharge*, uchar*, ClusterAccumulator*, MCLabelAccumulator*);
